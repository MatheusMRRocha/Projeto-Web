            ...
            ">
                ...
                ">
                    ...
                    <div style="padding: 20px;">
                        ...
                        <a href="noticias/noticia1.php" style=" /* APONTA PARA O ARQUIVO ÚNICO COM ID */
                ...
                ">
                    ...
                    <div style="padding: 20px;">
                        ...
                        <a href="noticias/noticia2.php" style=" /* APONTA PARA O ARQUIVO ÚNICO COM ID */
                            display: inline-block;
                            margin-top: 15px;
                            background-color: #3f51b5;
                            color: white;
                ...
                ">
                    ...
                    <div style="padding: 20px;">
                        ...
                        <a href="noticias/noticia3.php" style=" /* APONTA PARA O ARQUIVO ÚNICO COM ID */
                            display: inline-block;
                            margin-top: 15px;
                            background-color: #3f51b5;
                            color: white;
                ...
                ">
                    ...
                    <div style="padding: 20px;">
                        ...
                        <a href="noticias/noticia4.php" style=" /* APONTA PARA O ARQUIVO ÚNICO COM ID */
                            display: inline-block;
                            margin-top: 15px;
                            background-color: #3f51b5;
                            color: white;
                ...
                ">
                    ...
                    <div style="padding: 20px;">
                        ...
                        <a href="noticias/noticia9.php" style=" /* APONTA PARA O ARQUIVO ÚNICO COM ID */
                            display: inline-block;
                            margin-top: 15px;
                            background-color: #3f51b5;
                            color: white;
                ...
                ">
                    ...
                    <div style="padding: 20px;">
                        ...
                        <a href="noticias/noticia8.php" style=" /* APONTA PARA O ARQUIVO ÚNICO COM ID */
                            display: inline-block;
                            margin-top: 15px;
                            background-color: #3f51b5;
                            color: white;
                ...
                ">
                    ...
                    <div style="padding: 20px;">
                        ...
                        <a href="noticias/noticia10.php" style=" /* APONTA PARA O ARQUIVO ÚNICO COM ID */
                            display: inline-block;
                            margin-top: 15px;
                            background-color: #3f51b5;
                            color: white;
                ...
                ">
                    ...
                    <div style="padding: 20px;">
                        ...
                        <a href="noticias/noticia5.php" style=" /* APONTA PARA O ARQUIVO ÚNICO COM ID */
                            display: inline-block;
                            margin-top: 15px;
                            background-color: #3f51b5;
                            color: white;
                ...
                ">
                    ...
                    <div style="padding: 20px;">
                        ...
                        <a href="noticias/noticia7.php" style=" /* APONTA PARA O ARQUIVO ÚNICO COM ID */
                            display: inline-block;
                            margin-top: 15px;
                            background-color: #3f51b5;
                            color: white;
                ...
                ">
                    ...
                    <div style="padding: 20px;">
                        ...
                        <a href="noticias/noticia6.php" style=" /* APONTA PARA O ARQUIVO ÚNICO COM ID */
                            display: inline-block;
                            margin-top: 15px;
                            background-color: #3f51b5;
                            color: white;
